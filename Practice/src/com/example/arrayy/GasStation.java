...
/***
 * 
 * @author vkukkar There are N gas stations along a circular route, where the
 ...
 *         input arrays is a non-negative integer. Example 1:
 * 
...
public class GasStation {
	...
	public static void main(String[] args) {
		...
		System.out.println(new Double(1.5));
	}
